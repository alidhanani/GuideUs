...
public class RecyclerAdapterUser extends RecyclerView.Adapter<RecyclerAdapterUser.TestViewHolder>  {
    ...
    UserTopFragmentHome.OnButtonPressListener buttonListener;

    public void onAttach(Activity activity) {
        try {
            buttonListener = (UserTopFragmentHome.OnButtonPressListener) activity;
        } catch (ClassCastException e) {
            throw new ClassCastException(activity.toString() + " must implement onButtonPressed");
        }
    }

    public RecyclerAdapterUser(Context mcontext, ArrayList<ModelUserRecycler> recyclerList) {
        this.mcontext = mcontext;
        RecyclerList = recyclerList;
    }

    ArrayList<ModelUserRecycler> RecyclerList;
    ...
    public class TestViewHolder extends RecyclerView.ViewHolder {
        ...
        public TestViewHolder(View itemView) {
            super(itemView);
            resturant = (TextView) itemView.findViewById(R.id.txtUserHomeShowName);
            distance = (TextView) itemView.findViewById(R.id.txtUserHomeShowDistance);
            more = (TextView) itemView.findViewById(R.id.txtUserHomeShowMore);
...
//                    ((BusinessHomePageActivity) v.getContext()).AddFragment(userBottomMap);
                    ...
                    UserBottomFragmentHome userBottomFragmentHome = new UserBottomFragmentHome();
                    userBottomFragmentHome.setArguments(bundle);


                    ((UserHomePageActivity) v.getContext()).AddFragment(userBottomFragmentHome);
