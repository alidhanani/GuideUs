...
public class BusinessTopFragmentHome extends Fragment  implements  GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener  {
    ArrayList<ModelBusinessRecycler> RecyclerArrayListValue;
    static ArrayList<ModelBusinessRecycler> RecyclerArrayList = new ArrayList<>();
    View mView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.activity_business_home_top_frag, null );
        btnWork = (Button) mView.findViewById(R.id.txtBusHomeShowMore);
        ...
        final ArrayList<ModelBusinessRecycler> RecyclerArrayListForFire = new ArrayList<>();
        mDatabase = FirebaseDatabase.getInstance().getReference();
                    ...
                    for (DataSnapshot childSnapshot: dataSnapshot.getChildren()) {
                        ...
                        ValueEventListener postListener = new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot1) {
                                ...
                                final ModelBusinessRecycler modelRecycler = new ModelBusinessRecycler();
...
//                    Double result = SphericalUtil.computeDistanceBetween(here, there);
                                ...
                                ValueEventListener postListener = new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot2) {
                                        ...
                                        RecyclerAdapterBusiness recyclerAdapter = new RecyclerAdapterBusiness(getContext(),RecyclerArrayListForFire);
